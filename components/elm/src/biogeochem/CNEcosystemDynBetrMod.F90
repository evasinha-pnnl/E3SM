module CNEcosystemDynBetrMod
  ...
  use elm_varctl                , only : use_c13, use_c14, use_fates, use_dynroot, iac_present, use_fan, use_gcam_landuse
...
!!--------------------------------------------------------------
      ...
      !--------------------------------------------
       ...
       if (get_do_harvest() .or. (iac_present .and. use_gcam_landuse)) then
